...
<template>
    ...
    <div class="container">
      ...
      <!-- <nav class="nav mt-5"><a class="nav-link active" @click="showData('menu')">Menu</a><a class="nav-link" @click="showData('branch')">Cabang</a><a class="nav-link" href="#">Promo</a></nav> -->
      <hr>
    </div>
              ...
              <a v-for="(branch, index) in dbranchs.data" href="#" class="list-group-item list-group-item-action" aria-current="true" @click="showMenu(branch)">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1 d-flex flex-column justify-content-between">
                    <h6 class="fw-bold">{{ branch.branch_name }}
                      <small class="fw-light" style="font-size: 10px">400km</small>
                    </h6>
                    <div class="text-muted">
                      <i class="pi pi-map-marker"></i> {{ branch.branch_address }}
                    </div>
                    <div class="text-muted">
                      <i class="pi pi-phone"></i> {{ branch.branch_phone }}
                    </div>
...
export default {
    ...
    methods: {
        ...
        goToPayment() {
            ...
            this.$inertia.get('/cart', { carts: this.dcarts.data }, {
                onSuccess: () => {
